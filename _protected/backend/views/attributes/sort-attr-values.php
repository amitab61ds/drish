...
$this->title = $model->name.' - Values Sorting';
            ...
            <div class="box box-solid">
                <div class="box-body">
                    <p style="margin-bottom:0px;">
                        <?= Html::a('<i class="fa fa-angle-left"></i>Back to '.$model->name, ['view', 'id'=> $model->id], ['class' => 'btn btn-primary']) ?>
                        <?= Html::a('Sort Z-A', ['sort-alphabetically', 'id' => $model->id, 'order' => -1], ['class' => 'btn btn-primary pull-right margin-right']) ?>
                        <?= Html::a('Sort A-Z', ['sort-alphabetically',  'id' => $model->id, 'order' => 1], ['class' => 'btn btn-primary pull-right margin-right']) ?>
                    </p>
                </div>
            </div>
            <div class="box box-solid">
