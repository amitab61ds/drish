...
<header class="slider_top">       
        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-3 col-xs-5 pad-right">
                 <div class="header">
                 <a href="<?= Url::to(['site/index']) ?>" class="header-logo"><img src="<?= Yii::$app->params['baseurl'] ?>/uploads/settings/main/<?= Yii::$app->params['settings']['logo'] ?>" alt="Drish" title="Drish"></a>
                            ...
                            <ul>
                               <li class="user-icon">
								...
								<?php } ?>
									...
									<li>
									 <a href="#"  title="Wishlist">   <div class="heart-area">
                            ...
                            <ul>
                            	<li class="s-icon">
                                    <a> <i class="fa fa-search" aria-hidden="true"></i>
                                     	<span class="login-text">Search</span>
                                     </a>
                               </li>
                                <li class="user-icon">
								<?php 
